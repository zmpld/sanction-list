...
// 🚀 FIXED: Includes the specific unique entity name strings inside the identifier tracker composite key key 
function entityKey(record) {
  return [
    record['URL'] || '',
    record['Title'] || '',
    record['ReferenceNumber'] || '',
    record['WatchListType'] || '',
    record['LastNameCorporateName'] || '', // Track actual target identity string bounds
    record['FirstName'] || '',
  ]
    .join('|')
    .toLowerCase();
